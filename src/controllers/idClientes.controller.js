...
const query =
  "SELECT DISTINCT [idcliente],[nombre],[nombre_localidad],[nombre_provincia],[idvendedor],[vendedor],[supervisor] FROM [Bamana].[dbo].[vwCuboClientes] WHERE [nombre_provincia] = 'MISIONES'"
